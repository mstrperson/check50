...
class Recover(TestCase):
    ...
    hashes = ['c3ceda9dde5cf2212e96d6f61e2e849ac60e2c3cbdf0184f6e0c3b6ea5e69d31',
    ...
    def middle_images(self):
        ...
        c = 1
        while (c < 15):
            h = self.hash("0" + str(c).zfill(2) + ".jpg")
            if (h != Recover.hashes[c]):
                raise Error("recovered image does not match")
            c += 1
